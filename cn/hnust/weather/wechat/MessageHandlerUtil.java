...
import java.util.Map;
 ...
 public class MessageHandlerUtil {
	 ...
	 */
	 ...
	 private static String handleTextMessage(Map<String, String> map) {
	 	...
	 	if(content.equals("图片")){
		 		...
		 		responseMessage = buildTextMessage(map, imgMediaId);
		 		...
		 		responseMessage = buildTextMessage(map,voiceMediaId);
		 		...
		 		responseMessage = buildTextMessage(map, music);
		 		...
		 		responseMessage = buildTextMessage(map, video);
	...
	private static String buildTextMessage(Map<String, String> map, Video video) {
		// TODO Auto-generated method stub
		return null;
	}
	 ...
	 * @return 文本消息XML字符串
	 */
	 private static String buildTextMessage(Map<String, String> map, Music music) {
		 //发送方帐号
		 String fromUserName = map.get("FromUserName");
		 // 开发者微信号
		 String toUserName = map.get("ToUserName");
		 ...
		 return String.format(
				 "<xml>" +
	                     ...
	                     "<Content><![CDATA[%s]]></Content>" +
	              "</xml>",
	             fromUserName, toUserName, getMessageCreateTime(), music);
	 }
